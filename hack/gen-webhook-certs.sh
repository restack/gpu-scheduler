...
echo "Next steps:"
echo ""
echo "  1. Update Helm values with CA bundle:"
echo "     helm upgrade gpu-scheduler charts/gpu-scheduler -n ${NAMESPACE} \\"
echo "       --set webhook.caBundle=${CA_BUNDLE}"
echo ""
echo "  2. Or set in values.yaml:"
echo "     webhook:"
echo "       caBundle: ${CA_BUNDLE}"
echo ""
echo "  3. Verify webhook pod:"
echo "     kubectl get pods -l app=gpu-scheduler-webhook -n ${NAMESPACE}"
echo ""
echo "  4. Test with a pod:"
echo "     kubectl apply -f examples/simple-claim.yaml"
echo ""
